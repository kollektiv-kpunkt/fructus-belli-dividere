<div class="fbd-press-release mt-12 md:mt-20 p-4 md:p-6 fbd-card">
    <h3 class="italic">{{__("fbd.pressrelease.subtitle")}}</h3>
    ...
    <a href="{{__("fbd.pressrelease.link2")}}" class="fbd-button block mt-2" target="_blank">{{__("fbd.pressrelease.button2")}}</a>
</div>
